...
Run script from the parent directory using `python3 test_convo_prompt_with_user_input.py`
2025-09-04: test that removing hardcoding the stance in the initial message works
"""
...
def get_system_prompt(pid, treatment, topic, group):
    ...
    system_prompt = (
        ...
        + f"Keep your responses short and concise. Present well-reasoned supporting arguments; use concrete examples when appropriate. Maintain respect throughout the conversation and use simple language that an average person can understand. "
